...
USER_KEY_MESSAGE = "Динмаческий ключ для подключения:\n`{}`\nчерез приложение Outline"
GET_STATE_KEY = "Желаете получить статичный ключ, для подключения например через AndroidTV?"
SEND_STATE_KEY = "Ваш статичный ключ: `{}`"
